...
describe("Component Snapshots", () => {
  ...
  // test for RenewalRequests component
  // test("RenewalRequests component renders correctly", async () => {
  //   // define mock data for the API response
  //   const mockData = [
  //     {
  //       id: 1,
  ...
  //       ],
  //       reason: "reason",
  //       proof_document: "proof link",
  //     },
  //   ];
  //   // mock the API response
  //   axios.get.mockResolvedValue({ data: mockData });
  //   // render the component
  //   const { asFragment } = render(<RenewalRequests />);
  //   // wait for the component to update with the mock data
  //   await waitFor(() => {
  //     expect(axios.get).toHaveBeenCalledWith(
  ...
  //   expect(asFragment()).toMatchSnapshot();
  // });
  // test the Requests component
  // test("Requests component renders correctly", () => {
  //   // render the Requests component
  //   const { asFragment } = render(<Requests />);
  //   // compare the rendered component with a saved snapshot
  //   expect(asFragment()).toMatchSnapshot();
  // });
});
